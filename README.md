...
В данном проекте используется методология **БЭМ Nested** для файловой структуры и классов. Присутствуют элементы **Grid Layout**, **Flexbox** и **медиазапросы**. Для пользователя есть возможность изменять данные об имени и профессии через **форму**, реализованную в виде **pop-up**-окна.
...
:bulb: В дальнейших версиях появится возможность изменять аватар пользователя, добавлять свои фотографии с описанием, а также будет реализована функция "Поставить лайк".
______
